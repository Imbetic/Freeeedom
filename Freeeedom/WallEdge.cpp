...
WallEdge::WallEdge(sf::Vector2f p_position, sf::Vector2f p_size, int p_edge)
{
	m_edge = p_edge;
...
void WallEdge::Update(GameObject* p_player)
{
...
void WallEdge::Draw(sf::RenderWindow& p_renderer)
{
	p_renderer.draw(m_wall);

}

void WallEdge::DrawShadows(sf::RenderWindow& p_renderer)
{
...
sf::RectangleShape WallEdge::GetWall()
{
	return m_wall;
}

WallEdge::~WallEdge(void)
{
