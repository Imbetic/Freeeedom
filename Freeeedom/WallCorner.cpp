...
WallCorner::WallCorner(sf::Vector2f p_position, sf::Vector2f p_size, int corner)
{
	m_corner = corner;
...
void WallCorner::Update(GameObject* p_player)
{
...
void WallCorner::Draw(sf::RenderWindow& p_renderer)
{
	p_renderer.draw(m_wall);

}

void WallCorner::DrawShadows(sf::RenderWindow& p_renderer)
{
...
sf::RectangleShape WallCorner::GetWall()
{
	return m_wall;
}

WallCorner::~WallCorner(void)
{
